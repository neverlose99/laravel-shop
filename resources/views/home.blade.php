        ...
        <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
                <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                    <img loading="lazy" src="{{ asset('assets/images/home/demo3/slideshow-character1.png') }}" width="542" height="733" alt="Woman Fashion 1" class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 w-auto h-auto" />
...
<div class="container mw-1620 bg-white border-radius-10">
    ...
    <section class="category-carousel container">
        ...
        {{-- Nhớ dùng Ctrl+F để tìm và thay thế tất cả "assets/images" thành "{{ asset('assets/images/home/demo3/category_8.png') }}" --}}
    </section>
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{ route('products.show', $product->id) }}">
                        <img loading="lazy" src="{{ $product->image_url }}" width="258" height="313"
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div
                        ...
                        <form action="{{ route('cart.add') }}" method="POST" class="d-inline">
                          ...
                          <button type="submit" class="btn-link btn-link_lg me-4 text-uppercase fw-medium" style="border: none; background: none;">Add To Cart</button>
                        </form>
