                ...
                <div class="mb-4">
                    ...
                    @if($product->image)
                        <div class="card mb-3" style="max-width: 300px;">
                            ...
                            <div class="card-body">
                                <p class="card-text text-muted mb-0"><i class="fas fa-image me-2"></i>Hình ảnh hiện tại</p>
                            </div>
                        </div>
                    @endif
                    ...
                    <small class="text-muted">Để trống nếu không muốn thay đổi hình ảnh. Định dạng: JPG, PNG, GIF. Tối đa 2MB</small>
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                reader.onload = function(e) {
                    preview.innerHTML = `
                        <div class="card" style="max-width: 300px;">
                            ...
                            <div class="card-body">
                                <p class="card-text text-success mb-0"><i class="fas fa-image me-2"></i>Hình ảnh mới</p>
                            </div>
                        </div>
                    `;
                }
